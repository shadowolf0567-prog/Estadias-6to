...
INSERT INTO `clientes` (`id_cliente`, `nombre`, `no_cuenta`, `direccion`) VALUES ('41', 'Karla', '987', 'kh bi');
INSERT INTO `clientes` (`id_cliente`, `nombre`, `no_cuenta`, `direccion`) VALUES ('52', 'Karla', '987', '');
...
CREATE TABLE `correos` (
  ...
  CONSTRAINT `correos_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `clientes` (`id_cliente`)
) ENGINE=InnoDB AUTO_INCREMENT=87 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--Datos de tabla: correos
INSERT INTO `correos` (`id`, `correo`, `id_cliente`, `es_principal`) VALUES ('84', 'shadowolf0567@gmail.com', '40', '1');
INSERT INTO `correos` (`id`, `correo`, `id_cliente`, `es_principal`) VALUES ('85', 'davi6d@gmail.com', '40', '0');
INSERT INTO `correos` (`id`, `correo`, `id_cliente`, `es_principal`) VALUES ('86', 'shadowolf0567@gmail.com', '15', '1');
...
INSERT INTO `equipos` (`id_equipo`, `no_serie`, `modelo`, `id_cliente`, `inicio_contrato`, `fin_contrato`) VALUES ('54', '777', 'ionjih', NULL, '2026-06-19', '2026-07-04');
INSERT INTO `equipos` (`id_equipo`, `no_serie`, `modelo`, `id_cliente`, `inicio_contrato`, `fin_contrato`) VALUES ('55', '1', 'ionjih', '52', '2026-06-19', '2026-07-04');
...
INSERT INTO `reportes` (`id_reporte`, `reporte`, `fecha`, `tecnico`, `refaccion`, `estado`, `fecha_atencion`, `observaciones_atencion`, `descripcion`, `id_cliente`, `id_equipo`, `acciones`) VALUES ('22', 'kñjo', '2026-06-29', '', '', 'pendiente', NULL, NULL, 'ejemplo', '8', '47', NULL);
...
CREATE TABLE `telefonos` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_cliente` (`id_cliente`),
  CONSTRAINT `telefonos_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `clientes` (`id_cliente`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--Datos de tabla: telefonos
INSERT INTO `telefonos` (`id`, `telefono`, `id_cliente`, `es_principal`) VALUES ('13', '7', '40', '1');
INSERT INTO `telefonos` (`id`, `telefono`, `id_cliente`, `es_principal`) VALUES ('14', '9898', '40', '0');
INSERT INTO `telefonos` (`id`, `telefono`, `id_cliente`, `es_principal`) VALUES ('15', '0989', '15', '1');
INSERT INTO `telefonos` (`id`, `telefono`, `id_cliente`, `es_principal`) VALUES ('17', '56', '41', '1');
INSERT INTO `telefonos` (`id`, `telefono`, `id_cliente`, `es_principal`) VALUES ('18', '56', '52', '1');
